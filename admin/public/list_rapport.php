                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $users = API_ADMIN::get_rapport_list();
                                                            ...
                                                            ?>
                                                                <a href="">
                                                                    <tr>
                                                                        <th scope="row"><?= $i + 1 ?></th>
                                                                        <td><?= $users[$i]['RSRP'] ?></td>
                                                                        <td><?= $users[$i]['qualite'] ?></td>
                                                                        <td><?= $users[$i]['RSRQ'] ?></td>
                                                                        <td><?= $users[$i]['qualites'] ?></td>
                                                                        <td><?= $users[$i]['localisation'] ?></td>
                                                                        <td><?= $users[$i]['dates'] ?></td>
                                                                        <td><a href="assets/widget/delete_rapport.php?id_Rapport_intervension=<?= $users[$i]['id_Rapport_intervension'] ?>">Supprimer</a></td>
                                                                    </tr>
                                                                </a>
                                                            <?php  }
                                                            ?>
